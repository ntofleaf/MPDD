...
model = dict(
    # pretrained="work_dirs/eat_seq32_avec_northwind_ordinal_cls_7.84/20241215_130722_rmse7.84_cls0.0000_epoch_6.pth",
    neck=dict(
        type="EatNeck",
...
randomness = dict(seed=781650253, deterministic=True)
