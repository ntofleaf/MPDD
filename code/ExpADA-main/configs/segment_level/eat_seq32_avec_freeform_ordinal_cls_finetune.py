...
model = dict(
    pretrained="work_dirs/eat_freeform_ordinal_cls_v1.0_clip1000_noSeed_flip_lre-7_finetune/20241210_162702_rmse8.12_cls0.0000_epoch_15.pth",
    neck=dict(
        type="EatNeck",
...
train_dataloader = dict(
    ...
    num_workers=WORKERS,
    dataset=dict(
        data_root='./data/avec_2014_freeform',
        seg_len=INPUT_SEQUENCE_LEN,
        steps=STEPS,
        cls_label_type='ordinal',
        clip_length=1000,  # the median length of the videos in the testing set
...
# optimizer
optim_wrapper = dict(
    optimizer=dict(type='Adam', lr=4e-7, weight_decay=0.0001))
