...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-track1_elder_continue_grid_avgp_ternary_wav2vec_openface_v9}"

echo "[Track1][A-V-G+P][ternary] audio=${AUDIO_FEATURE} video=${VIDEO_FEATURE} seed=${SEED} target_t=${TARGET_T}"
cd "$PROJECT_ROOT"
