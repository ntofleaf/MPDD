# -*- coding: utf-8 -*-
"""
Extract ResNet50 frame-level visual features from original videos (no sliding window).
Default behavior:
- no windowing
...
def process_original_videos(
    ...
    if model_name != "resnet50":
        print(f"[WARN] unknown model={model_name}, fallback to resnet50")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract ResNet features from original videos (no sliding window).")
    parser.add_argument("--root_dir", type=str, default="/home/disk2/zelin/MM2025_Challenge/withdisease/basicdisease/原始数据")
    parser.add_argument("--save_dir", type=str, default="/home/disk2/shangming/feature_extract/feature_frame/video/resnet")
