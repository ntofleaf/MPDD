...
class LastFrameConsensus(nn.Module):
...
class TSNHead(BaseHead):
    ...
    def __init__(self,
        ...
        elif get_str_type(consensus_type) == 'LastFrameConsensus':
            self.consensus = LastFrameConsensus(**consensus_)
        else:
            self.consensus = None
        ...
        if self.dropout_ratio != 0:
            ...
            self.dropout = None
        # self.fc_cls = nn.Linear(self.in_channels * 2, self.num_classes)
